...
После применения набора черновика названия выбранных стиля и макета обновляются в редакторе и сводке настроек. При удалении набора черновика можно также удалить связанные сохранённые стиль и макет, если они больше не используются; общие элементы при отказе остаются в библиотеке.
